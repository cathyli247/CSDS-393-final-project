...
from .serializers import CommentSerializer, CommentCreateSerializer, CommentDeleteSerializer
...
@api_view(['DELETE'])
def comment_delete_view(request, slug):
    try:
        instance = Comment.objects.get(slug=slug)
        instance.delete()
